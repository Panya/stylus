...
var Parser = module.exports = function Parser(str, options) {
  var self = this
  options = options || {};
  var _opts = merge({}, options);
  var hash = crypto.createHash('sha1');
  _opts.filename = '';
  hash.update(str + JSON.stringify(_opts));
  this.hash = hash.digest('hex');
  if (!Parser.isCached(this.hash)) {
